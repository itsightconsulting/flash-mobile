...
public class VeridiumFourFInstructionalFragment extends VeridiumBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.layout_veridium_4f_instructional, container, false);
    }
    ...
    protected void initView(final View view) {
        ...
        videoview.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
                try {
                    ...
                    introMediaPlayer = MediaPlayer.create(VeridiumFourFInstructionalFragment.this.getContext(), R.raw.veridium_instructional_fourf_left);
        ...
        ((VeridiumFourFBiometricActivity) baseActivity).onInstructionalFragmentReady(this);
    }
