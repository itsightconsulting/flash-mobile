package com.veridiumid.sdk.individualfingerselector;
...
public class DefaultFourFMissingFingerSelectionActivity extends VeridiumBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.veridiumid.sdk.individualfingerselector.R.layout.activity_fragment_main);
        showFragment(new DefaultFourFMissingFingerSelectionFragment());
    }

    public void onMissingFingerFragmentReady(final DefaultFourFMissingFingerSelectionFragment missingFingerFragment){
        ...
        missingFingerFragment.btn_getStarted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(getFingerRemoved(Fingers.INDEX) && getFingerRemoved(Fingers.MIDDLE) && getFingerRemoved(Fingers.RING) && getFingerRemoved(Fingers.LITTLE) && getFingerRemoved(Fingers.THUMB)) {
                    ...
                    Toast t = Toast.makeText(DefaultFourFMissingFingerSelectionActivity.this, "Cannot continue because all fingers have been selected as missing.",
                            Toast.LENGTH_LONG);
    ...
    private void flipImages(DefaultFourFMissingFingerSelectionFragment missingFingerFragment){
    ...
    private void flipImage(DefaultFourFMissingFingerSelectionFragment missingFingerFragment, ImageView hand) {
        Bitmap outputHand;
