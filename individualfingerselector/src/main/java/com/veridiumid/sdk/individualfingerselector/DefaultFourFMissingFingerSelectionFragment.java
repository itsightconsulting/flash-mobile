...
public class DefaultFourFMissingFingerSelectionFragment extends VeridiumBaseFragment {
    ...
    protected void initView(final View view) {
        ...
        ((DefaultFourFMissingFingerSelectionActivity) baseActivity).onMissingFingerFragmentReady(this);
    }
