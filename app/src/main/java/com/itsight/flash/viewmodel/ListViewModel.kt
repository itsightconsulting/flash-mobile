...
import com.itsight.flash.util.NotificationsHelper
import com.itsight.flash.util.SharedPreferencesHelper
...
class ListViewModel(application: Application) : BaseViewModel(application) {
    ...
    val carouselLoadError = MutableLiveData<Boolean>()
