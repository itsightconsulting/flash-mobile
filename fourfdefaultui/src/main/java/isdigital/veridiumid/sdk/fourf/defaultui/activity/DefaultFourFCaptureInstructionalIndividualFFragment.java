package isdigital.veridiumid.sdk.fourf.defaultui.activity;
...
public class DefaultFourFCaptureInstructionalIndividualFFragment extends VeridiumBaseFragment {
    ...
    protected void initView(final View view)
    {
        ...
        // Set text
        tv_animationInfo.setText(getString(R.string.individual_instructions));
        ...
        videoview.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
                try {
                    ...
                    introMediaPlayer = MediaPlayer.create(DefaultFourFCaptureInstructionalIndividualFFragment.this.getContext(), R.raw.individual_finger_animation_android);
                    ...
                    introMediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                        ...
                        public void onPrepared(MediaPlayer mediaPlayer) {
                            ...
                            int screenWidth = DefaultFourFCaptureInstructionalIndividualFFragment.this.getActivity().getWindowManager().getDefaultDisplay().getWidth();
        ...
        ((DefaultFourFBiometricsActivity) baseActivity).onInstructionalIndividualFFragmentReady(this);
    }
