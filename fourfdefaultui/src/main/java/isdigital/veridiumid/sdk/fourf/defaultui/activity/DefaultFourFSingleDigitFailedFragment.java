...
public class DefaultFourFSingleDigitFailedFragment extends VeridiumBaseFragment {
    ...
    protected void initView(final View view)
    {
        ...
        tv_animationInfo.setText(getString(R.string.singleDigit_failed_advice));
        ...
        ((DefaultFourFBiometricsActivity) baseActivity).onSingleDigitFailedFragmentReady(this);
    }
