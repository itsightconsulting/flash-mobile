...
public class DefaultFourFCaptureInstructionalThumbFragment extends VeridiumBaseFragment {
    ...
    protected void initView(final View view)
    {
        ...
        // Set text
        tv_animationInfo.setText(getString(R.string.thumb_instructions));
        ...
        videoview.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
                try {
                    ...
                    introMediaPlayer = MediaPlayer.create(DefaultFourFCaptureInstructionalThumbFragment.this.getContext(), R.raw.animation_thumb);
                    ...
                    introMediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                        ...
                        public void onPrepared(MediaPlayer mediaPlayer) {
                            ...
                            int screenWidth = DefaultFourFCaptureInstructionalThumbFragment.this.getActivity().getWindowManager().getDefaultDisplay().getWidth();
